# Generated by Django 4.1.5 on 2023-01-17 12:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('position', models.CharField(choices=[('ART', 'статья'), ('NEW', 'новость')], default='-', max_length=5)),
                ('time', models.DateTimeField(auto_now_add=True)),
                ('post_topic', models.CharField(default='Тут мог быть загаловок', max_length=255)),
